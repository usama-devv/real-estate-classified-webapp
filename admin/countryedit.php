...
if(isset($_POST['insert']))
{
	...
	$sql="UPDATE country SET coname = '{$country}'  WHERE coid = {$coid}";
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<?php 
								$coid = $_GET['id'];
								$sql = "SELECT * FROM country where coid = {$coid}";
								$result = mysqli_query($con, $sql);
											...
											<div class="row">
												<div class="col-xl-6">
													...
													<div class="form-group row">
														...
														<div class="col-lg-9">
															<input type="text" class="form-control" name="country" value="<?php echo $row['1']; ?>">
														</div>
													</div>
												</div>
											</div>
