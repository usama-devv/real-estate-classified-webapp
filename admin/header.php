                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-location"></i> <span>Country & State & City</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a href="typeadd.php"> Add Property Type </a></li>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-comment"></i> <span> FAQ's </span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="faqadd.php"> Add FAQ's </a></li>
									<li><a href="faqview.php"> View FAQ's </a></li>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-comment"></i> <span> T&C </span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="T&Cadd.php"> Add T&C </a></li>
									<li><a href="T&Cview.php"> View T&C </a></li>
