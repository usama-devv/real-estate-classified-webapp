...
if(isset($_POST['add']))
{
	...
	size='{$asize}', price='{$price}', location='{$loc}', country='{$country}', city='{$city}', state='{$state}', feature='{$feature}',
...
<head>
        ...
        <title>Khokhar | Property Update</title>
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select type="text" class="form-control" name="country" required value="<?php echo $row['17']; ?>">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select type="text" class="form-control" name="state" required value="<?php echo $row['16']; ?>">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select type="text" class="form-control" name="city" required value="<?php echo $row['15']; ?>">
