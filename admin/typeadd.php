...
if(isset($_POST['insert']))
{
	...
	if(!empty($type)){
		...
		if($result)
			{
				$msg="<p class='alert alert-success'>Type Inserted Successfully</p>";
						
			}
			else
			{
				$error="<p class='alert alert-warning'>* Type Not Inserted</p>";
			}
	}
	else{
						...
						<div class="col-sm-12">
							<div class="card">
								...
								<div class="card-body">
									...
									<table id="basic-datatable " class="table table-bordered table-hover" id="list">
										<colgroup>
					                        <col width="5%">
					                        <col width="15%">
					                        <col width="20%">
											...
											?>
                                                <tr>
													...
													<td><a href="typeedit.php?id=<?php echo $row['0']; ?>"><button class="btn btn-info">Edit</button></a>
                                                    <a href="typedelete.php?id=<?php echo $row['0']; ?>"><button class="btn btn-danger">Delete</button></a></td>
                                                </tr>
                                                <?php $cnt=$cnt+1; } ?>
