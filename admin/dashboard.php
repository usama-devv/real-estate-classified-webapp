						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where type = 'Residential'";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
										
										<h6 class="text-muted">No. of Residents</h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-info w-50"></div>
										</div>
									</div>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where type = 'Commercial'";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
										
										<h6 class="text-muted">No. of Commercial</h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-info w-50"></div>
										</div>
									</div>
