						...
						<div class="col-md-12">
							<div class="card">
								...
								<input type="text" class="form-control" name="question" required="">
									...
									<div class="col-lg-9">
									<textarea class="tinymce form-control" name="answer" rows="10" cols="30"></textarea>
										</div>
										</div>
										</div>
										</div>
									<div class="text-left">
									<input type="submit" class="btn btn-primary"  value="Submit" name="faq" style="margin-left:200px;">
										</div>
									</form>
								</div>
