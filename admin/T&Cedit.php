...
if(isset($_POST['update']))
{
	...
	$sql = "UPDATE terms SET title = '{$title}' , content = '{$content}', image ='{$aimage}' WHERE id = {$id}";
	$result=mysqli_query($con,$sql);
	if($result == true)
	{
		$msg="<p class='alert alert-success'>Terms and Conditions Updated</p>";
		header("Location:T&Cview.php?msg=$msg");
	}
	else{
		$msg="<p class='alert alert-warning'>Terms and Conditions Not Updated</p>";
		header("Location:T&Cview.php?msg=$msg");
	}
}
?>
...
<head>
        ...
        <title>Real Estate - Terms and Conditions</title>
            ...
            <div class="page-wrapper">
				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">T & C</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
									<li class="breadcrumb-item active">T & C</li>
								</ul>
							</div>
						</div>
					</div>
