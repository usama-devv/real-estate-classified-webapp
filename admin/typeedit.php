...
if(isset($_POST['insert']))
{
	...
	if($result)
		{
			$msg="<p class='alert alert-success'>Type Updated</p>";
			header("Location:typeadd.php?msg=$msg");
		}
		else
		{
			$msg="<p class='alert alert-warning'>type Not Updated</p>";
			header("Location:typeadd.php?msg=$msg");
		}	
}
?>
											...
											<div class="row">
												<div class="col-xl-6">
													...
													<div class="form-group row">
														...
														<div class="col-lg-9">
															<input type="text" class="form-control" name="type" value="<?php echo $row['1']; ?>">
														</div>
													</div>
