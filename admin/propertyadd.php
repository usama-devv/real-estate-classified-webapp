...
if(isset($_POST['add']))
{
	...
	$sql="INSERT INTO property (title,pcontent,type,stype,bedroom,bathroom,balcony,kitchen,hall,floor,size,price,location,country,city,state,feature,pimage,pimage1,pimage2,pimage3,pimage4,uid,status,mapimage,topmapimage,groundmapimage,totalfloor,isFeatured)
	VALUES('$title','$content','$ptype','$stype','$bed','$bath','$balc','$kitc','$hall','$floor','$asize','$price',
	'$loc','$country','$city','$state','$feature','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','$uid','$status','$fimage','$fimage1','$fimage2','$totalfloor','$isFeatured')";
...
<head>
        ...
        <title>Khokhar | Property Add</title>
