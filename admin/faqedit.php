...
if(isset($_POST['update']))
{
	...
	if($result == true)
	{
		$msg="<p class='alert alert-success'>FAQ Updated</p>";
		header("Location:faqview.php?msg=$msg");
	}
	else{
		$msg="<p class='alert alert-warning'>FAQ Not Updated</p>";
		header("Location:faqview.php?msg=$msg");
	}
}
?>
					...
					<div class="row">
						...
						<form method="post" enctype="multipart/form-data">
							...
							<h5 class="card-title">FAQ's </h5>
								...
								<div class="col-lg-9">
									<input type="text" class="form-control" name="uquestion" value="<?php echo $row['1']; ?>">
													</div>
										</div>
								<div class="form-group row">
									<label class="col-lg-2 col-form-label">Answer</label>
									<div class="col-lg-9">
									<textarea class="tinymce form-control" name="uanswer" rows="10" cols="30"><?php echo $row['2']; ?></textarea>
											</div>
									        </div>
									</div>
									</div>
