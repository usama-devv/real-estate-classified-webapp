...
if(isset($_POST['add']))
{
	...
	$sql="insert into property (title,pcontent,type,stype,bedroom,bathroom,balcony,kitchen,hall,floor,size,price,location,city,state,country,feature,pimage,pimage1,pimage2,pimage3,pimage4,uid,status,mapimage,topmapimage,groundmapimage,totalfloor)
	values('$title','$content','$ptype','$stype','$bed','$bath','$balc','$kitc','$hall','$floor','$asize','$price',
	'$loc','$city','$state','$country','$feature','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','$uid','$status','$fimage','$fimage1','$fimage2','$totalfloor')";
								...
								<div class="description">
									...
									<?php echo $msg; ?>
										...
										<div class="row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="bath"  placeholder="Enter Bathroom">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Kitchen</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="kitc"  placeholder="Enter Kitchen">
													</div>
												</div>
											...
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="bed"  placeholder="Enter Bedroom">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Balcony</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="balc"  placeholder="Enter Balcony">
													</div>
												</div>
												<div class="form-group row">
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select type="text" class="form-control" name="country" required placeholder="Select Country">
														<option value="" selected="selected">Select Country</option>
				                                                <?php
				                                                $sql = "SELECT coname FROM country";
				                                                $resultset = mysqli_query($con, $sql);
				                                                while( $rows = mysqli_fetch_assoc($resultset) ) 
				                                                { 
				                                                ?>
				                                            <option value=""><?php echo $rows["coname"]; ?></option>
				                                                    <?php }	?>
			                                                        </select>
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select type="text" class="form-control" name="state" required placeholder="Select State">
														<option value="" selected="selected">Select State</option>
				                                                <?php
				                                                $sql = "SELECT sname FROM state";
				                                                $resultset = mysqli_query($con, $sql);
				                                                while( $rows = mysqli_fetch_assoc($resultset) ) 
				                                                { 
				                                                ?>
				                                            <option value=""><?php echo $rows["sname"]; ?></option>
				                                                    <?php }	?>
			                                                        </select>
													</div>
												</div>
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select type="text" class="form-control" name="city" required placeholder="Select City">
											...
											<textarea class="tinymce form-control" name="feature" rows="10" cols="30">
												...
												<div class="col-md-4">
													...
													<div class="col-md-4">
														...
														<li class="mb-3"><span class="text-secondary font-weight-bold">School\College\Uni : </span>Near By 2KM</li>
										...
										<!--<div class="row">
											...
											<input type="submit" value="Submit Property" class="btn btn-success"name="add" style="margin-left:200px;">
